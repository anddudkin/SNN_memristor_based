...
def snn(ar):
    ...
    data_train = MNIST_train_test_14x14(root="/home/anddudkin/PycharmProjects/SNN_memristor_based/Memristor/stuck_elements_tests/data")[0]
    data_test = MNIST_train_test_14x14(root="/home/anddudkin/PycharmProjects/SNN_memristor_based/Memristor/stuck_elements_tests/data")[1]
...
if __name__ == "__main__":
    ...
    result = pool.map(snn, [2048,2048,2048,2048,2048])
