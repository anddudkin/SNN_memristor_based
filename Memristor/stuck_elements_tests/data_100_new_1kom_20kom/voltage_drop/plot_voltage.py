...
#w1=np.full([196, 50], 10000)
w1= np.random.randint(1000, 20000, size=(196, 50))
w2= np.random.randint(1, 20, size=(196, 50))
y1 = plt.imshow(w2, cmap="gray", interpolation='None')
x1=plt.colorbar(y1)
